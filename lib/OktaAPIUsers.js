 ...
 * @constructor
 */
function OktaAPIUsers(apiToken, clientId, clientSecret, domain, preview)
{
 ...
 * @param callback
 */
OktaAPIUsers.prototype.testAuthn = function(data, callback)
{
    this.request.post("authn", data, true, callback);
}
/**
...
/**
 * ADMIN function: set password without validating the current password
 * @method setPassword
 * @param id
 * @param newPasswordValue
 * @param callback
 */
OktaAPIUsers.prototype.setPassword = function(id, newPasswordValue, callback)
{
    if(id == undefined) throw new Error("A user ID is required when changing a users password");
    if(newPasswordValue == undefined) throw new Error("A new password value is required when setting a users password");
    var body = {
        credentials: {
            password: {
    ...
    this.request.post("users/" + id, body, null, callback);
}

/**
 * ADMIN function: set recovery question and answer without validating the current password
 * @method setPassword
 * @param id
 * @param newPasswordValue
 * @param callback
 */
OktaAPIUsers.prototype.setRecoveryQuestionDetails = function(id, newRecoveryQuestion, newRecoveryAnswer, callback)
{
    if(id == undefined) throw new Error("A user ID is required when changing a users password");
    if(newRecoveryQuestion == undefined) throw new Error("A new recovery question is required when setting a users recovery question");
    if(newRecoveryAnswer == undefined) throw new Error("A new recovery answer is required when setting a users recovery question");
    var body = {
        credentials: {
            recovery_question: {
                question: newRecoveryQuestion,
                answer: newRecoveryAnswer
            }
        }
    };
    this.request.post("users/" + id, body, null, callback);
